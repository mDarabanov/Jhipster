...
export class DelegationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.delegationService
      ...
      .subscribe(
        (res: HttpResponse<IDelegation[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInDelegations(): void {
    this.eventSubscriber = this.eventManager.subscribe('delegationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDelegation[] | null, headers: HttpHeaders, page: number): void {
